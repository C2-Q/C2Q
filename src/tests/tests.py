...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        ...
        env_model = os.getenv("C2Q_MODEL_PATH")
        candidates = []
        if env_model:
    ...
    def test_is_pdf_generation(self):
        # parse is_snippet and get problem type and extract json
    ...
    #def test_calibration_data_fetching(self):
        # Fetch the available devices and their calibration json.
        ...
        # Use the list of available devices to fetch calibration json
